/**
 * Project Made by shadow(Ömer Faruk Açar)
 * Aira.js
 * Aira is a artificial intelligence library that is currently under development.
 * Simple AI Neural Network gives you score 
 * Maybe you use in game AI
 */
...
class Neuron {
    constructor(iSize) { 
    this.weights = Array.from({length: iSize}, () => Math.random())
...
class NeuralNetwork {
    ...
    constructor(inputSize,hiddenSize,outputSize) {
      this.hiddenLayer = Array.from({length: inputSize}, () => new Neuron(4))
...
const testword =  console.log(vectorize(Tokenizer(sentence)))
